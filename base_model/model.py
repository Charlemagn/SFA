...
from .our_layers import FABlock, SFABlock
...
class Base_model(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            feature_attention: The choice of feature attention:None,'FA','SFA'.
                Defaults to 'SFA'.
    ...
    def forward(self,
        ...
        if self.feature_attention == 'FA':
            attended_premises = FABlock(dim = self.dim)(attended_premises)
            attended_hypotheses = FABlock(dim = self.dim)(attended_hypotheses)

        if self.feature_attention == 'SFA':
            attended_premises = SFABlock(dim1 = self.dim1, dim2= self.dim2)(attended_premises)
            attended_hypotheses = SFABlock(dim1 = self.dim1, dim2= self.dim2)(attended_hypotheses)
